...
export const createLessonSchema = z.object({
  ...
  language: z.enum(['spanish', 'french', 'german', 'italian', 'portuguese', 'japanese', 'chinese']),
  type: z.enum(['vocabulary', 'grammar', 'phrases']),
...
export const lessonFilterSchema = z.object({
  language: z.enum(['spanish', 'french', 'german', 'italian', 'portuguese', 'japanese', 'chinese']).optional(),
  type: z.enum(['vocabulary', 'grammar', 'phrases']).optional(),
